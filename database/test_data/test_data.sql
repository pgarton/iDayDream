...
insert into volunteers values (null, false, 'Alex', 'Anderson', '253-111-1111', 'Emaret2@mail.greenriver.edu', true, '111 Apple St', 'Apt. 1', true, 'Tacoma', 98188, 1, 1, 'Other Role Text', 0, 'WA', 1, 1, 1, "Special Skills", 1, "Volunteer exp", 1, "non-Volunteer experience", now(), now());
insert into volunteers values (null, true, 'Betty', 'Benjamin', '253-111-1111', 'Dsloan4@mail.greenriver.edu', false, '111 Apple St', 'Apt. 1', false, 'Tacoma', 98188, 0, 1, 'Other Role Text', 1, 'WA', 1, 1, 1, "Special Skills", 1, "Volunteer exp", 1, "non-Volunteer experience", now(), now());
insert into volunteers values (null, false , 'Charlie', 'Cicarello', '253-111-1111', 'Pgarton@mail.greenriver.edu', false, '111 Apple St', 'Apt. 1', true, 'Tacoma', 98188, 1, 1, 'Other Role Text', 2, 'WA', 1, 1, 1, "Special Skills", 1, "Volunteer exp", 1, "non-Volunteer experience", now(), now());
insert into volunteers values (null, true, 'Doris', 'Davis', '253-111-1111', 'Emaret2@mail.greenriver.edu', true, '111 Apple St', 'Apt. 1', false, 'Tacoma', 98188, 0, 0, 'Other Role Text', 0, 'WA', 1, 1, 0, null, 0, null, 0, null, now(), now());
insert into volunteers values (null, false , 'Edward', 'Edwards', '253-111-1111', 'Dsloan4@mail.greenriver.edu', true, '111 Apple St', 'Apt. 1', true, 'Tacoma', 98188, 1, 0, 'Other Role Text', 1, 'WA', 1, 1, 0, null, 0, null, 0, null, now(), now());
insert into volunteers values (null, true, 'Fran', 'Francis', '253-111-1111', 'Pgarton@mail.greenriver.edum', false, '111 Apple St', 'Apt. 1', false, 'Tacoma', 98188, 0, 0, 'Other Role Text', 2, 'WA', 1, 1, 0, null, 0, null, 0, null, now(), now());
insert into volunteers values (null, false , 'Grant', 'Griggs', '253-111-1111', 'Emaret2@mail.greenriver.edu', false, '111 Apple St', 'Apt. 1', true, 'Tacoma', 98188, 1, 1, 'Other Role Text', 0, 'WA', 1, 1, 0, null, 0, null, 0, null, now(), now());
insert into volunteers values (null, true, 'Helen', 'Hopewell', '253-111-1111', 'Dsloan4@mail.greenriver.edu', true, '111 Apple St', 'Apt. 1', false, 'Tacoma', 98188, 0, 1, 'Other Role Text', 1, 'WA', 1, 1, 0, null, 0, null, 0, null, now(), now());
insert into volunteers values (null, false , 'Igor', 'Ignatowski', '253-111-1111', 'Pgarton@mail.greenriver.edum', false, '111 Apple St', 'Apt. 1', true, 'Tacoma', 98188, 1, 0, 'Other Role Text', 2, 'WA', 1, 1, 0, null, 0, null, 0, null, now(), now());
insert into volunteers values (null, true, 'Janet', 'Jackson', '253-111-1111', 'Emaret2@mail.greenriver.edu', true, '111 Apple St', 'Apt. 1', false, 'Tacoma', 98188, 0, 0, 'Other Role Text', 0, 'WA', 1, 1, 0, null, 0, null, 0, null, now(), now());
insert into volunteers values (null, false , 'Kyle', 'King', '253-111-1111', 'Dsloan4@mail.greenriver.edu', false, '111 Apple St', 'Apt. 1', true, 'Tacoma', 98188, 1, 1, 'Other Role Text', 1, 'WA', 1, 1, 0, null, 0, null, 0, null, now(), now());
insert into volunteers values (null, true, 'Lina', 'Lazurus', '253-111-1111', 'Pgarton@mail.greenriver.edu', true, '111 Apple St', 'Apt. 1', false, 'Tacoma', 98188, 0, 0, 'Other Role Text', 2, 'WA', 1, 1, 0, null, 0, null, 0, null, now(), now());
