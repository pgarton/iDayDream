...
insert into youth (active, first_name, last_name, home_phone, email, graduating_class, college_of_interest, career_aspirations,
	...
	values 	(0, 'Albert', 'Anderson', '442-222-3322', 'Pgarton@mail.greenriver.edu', 2021, 'UA', 'Doctor', 'Hot Dogs', '2003-02-02', null, 2, 1, 'Cindy Anderson', '253-111-1111', 'cindy@anderson.com'),
			...
			(2, 'Chandra', 'Cox', '552-222-3322', 'Emaret2@mail.greenriver.edu', 2021, 'UC', 'Doctor', 'Chips', '2002-07-02', '', 4, 2, 'Cindy Cox', '253-111-1111', 'bill@cox.com'),
			...
			(2, 'Floyd', 'Franklin', '552-222-3322', 'Emaret2@mail.greenriver.edu', 2020, 'UF', 'Lawyer', 'Carrots', '2002-07-02', '', 7, 1, 'Cindy Franklin', '253-111-1111', 'cindy@franklin.com'),
			...
			(2, 'Imelda', 'Irving', '552-222-3322', 'Emaret2@mail.greenriver.edu', 2023, 'UI', 'Lawyer',  'Ice Cream', '2002-07-02', 'Filipino/Samoan', 10, 3, 'Cindy Irving', '253-111-1111', 'cindy@irving.com'),
			...
			(2, 'Lawrence', 'Lawson', '552-222-3322', 'Emaret2@mail.greenriver.edu', 2022, 'UL', 'Lawyer',  'Fruit', '2002-07-02', '', 7, 1, 'Bill Lawson', '253-111-1111', 'bill@lawson.com'),
			(0, 'Mary', 'Matthews', '552-222-3322', 'Pgarton@mail.greenriver.edu', 2023, 'UM', 'Police Chief',  'Jello', '2002-07-02', '', 6, 2, 'Bill Matthews', '253-111-1111', 'bill@matthews.com'),
			...
			(2, 'Olivia', 'Olson', '552-222-3322', 'Emaret2@mail.greenriver.edu', 2021, 'UO', 'Police Chief',   'Yogurt', '2002-07-02', '', 4, 2, 'Bill Olson', '253-111-1111', 'bill@olson.com'),
			(0, 'Peter', 'Peterson', '552-222-3322', 'Pgarton@mail.greenriver.edu', 2022, 'UP', 'Police Chief',   'Spinach', '2002-07-02', '', 3, 1, 'Bill Peterson', '253-111-1111', 'bill@perterson.com'),
			...
			(2, 'Ronald', 'Robertson', '552-222-3322', 'Emaret2@mail.greenriver.edu', 2021, 'UR', 'Police Chief',   'Candy', '2002-07-02', '', 1, 1, 'Bill Robertson', '253-111-1111', 'bill@robertson.com'),
...
insert into volunteers values (null, 0, 'Alex', 'Anderson', '253-111-1111', 'Emaret2@mail.greenriver.edu', true, '111 Apple St', 'Apt. 1', true, 'Tacoma', 98188, 1, 'Friday: After 5', 1, 'Other Role Text', 1, 'WA', 1, 1, 1, "Special Skills", 1, "Volunteer exp", 1, "non-Volunteer experience", now(), now());
insert into volunteers values (null, 1, 'Betty', 'Benjamin', '253-111-1111', 'Dsloan4@mail.greenriver.edu', false, '111 Apple St', 'Apt. 1', false, 'Tacoma', 98188, 0, '', 1, 'Other Role Text', 1, 'WA', 1, 1, 1, "Special Skills", 1, "Volunteer exp", 1, "non-Volunteer experience", now(), now());
insert into volunteers values (null, 2, 'Charlie', 'Cicarello', '253-111-1111', 'Pgarton@mail.greenriver.edu', false, '111 Apple St', 'Apt. 1', true, 'Tacoma', 98188, 1, 'Friday: After 5', 1, 'Other Role Text', 2, 'WA', 1, 1, 1, "Special Skills", 1, "Volunteer exp", 1, "non-Volunteer experience", now(), now());
insert into volunteers values (null, 0, 'Doris', 'Davis', '253-111-1111', 'Emaret2@mail.greenriver.edu', true, '111 Apple St', 'Apt. 1', false, 'Tacoma', 98188, 0, '',0, 'Other Role Text', 1, 'WA', 1, 1, 0, null, 0, null, 0, null, now(), now());
insert into volunteers values (null, 1, 'Edward', 'Edwards', '253-111-1111', 'Dsloan4@mail.greenriver.edu', true, '111 Apple St', 'Apt. 1', true, 'Tacoma', 98188, 1, 'Friday: After 5', 0, 'Other Role Text', 1, 'WA', 1, 1, 0, null, 0, null, 0, null, now(), now());
insert into volunteers values (null, 2, 'Fran', 'Francis', '253-111-1111', 'Pgarton@mail.greenriver.edum', false, '111 Apple St', 'Apt. 1', false, 'Tacoma', 98188, 0, '',0, 'Other Role Text', 1, 'WA', 1, 1, 0, null, 0, null, 0, null, now(), now());
insert into volunteers values (null, 0, 'Grant', 'Griggs', '253-111-1111', 'Emaret2@mail.greenriver.edu', false, '111 Apple St', 'Apt. 1', true, 'Tacoma', 98188, 1, 'Friday: After 5', 1, 'Other Role Text', 0, 'WA', 1, 1, 0, null, 0, null, 0, null, now(), now());
insert into volunteers values (null, 1, 'Helen', 'Hopewell', '253-111-1111', 'Dsloan4@mail.greenriver.edu', true, '111 Apple St', 'Apt. 1', false, 'Tacoma', 98188, 0, '',1, 'Other Role Text', 1, 'WA', 1, 1, 0, null, 0, null, 0, null, now(), now());
insert into volunteers values (null, 2, 'Igor', 'Ignatowski', '253-111-1111', 'Pgarton@mail.greenriver.edum', false, '111 Apple St', 'Apt. 1', true, 'Tacoma', 98188, 1, 'Friday: After 5', 0, 'Other Role Text', 1, 'WA', 1, 1, 0, null, 0, null, 0, null, now(), now());
insert into volunteers values (null, 0, 'Janet', 'Jackson', '253-111-1111', 'Emaret2@mail.greenriver.edu', true, '111 Apple St', 'Apt. 1', false, 'Tacoma', 98188, 0, 'F', 0, 'Other Role Text', 1, 'WA', 1, 1, 0, null, 0, null, 0, null, now(), now());
insert into volunteers values (null, 1, 'Kyle', 'King', '253-111-1111', 'Dsloan4@mail.greenriver.edu', false, '111 Apple St', 'Apt. 1', true, 'Tacoma', 98188, 1, 'Friday: After 5', 1, 'Other Role Text', 1, 'WA', 1, 1, 0, null, 0, null, 0, null, now(), now());
insert into volunteers values (null, 2, 'Lina', 'Lazurus', '253-111-1111', 'Pgarton@mail.greenriver.edu', true, '111 Apple St', 'Apt. 1', false, 'Tacoma', 98188, 0, '', 0, 'Other Role Text', 1, 'WA', 1, 1, 0, null, 0, null, 0, null, now(), now());
